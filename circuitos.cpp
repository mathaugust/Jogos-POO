...
void Mostrar_Circuito(bool cod1, bool cod2, bool cod3, bool cod4)
{
	...
	// -> Caso o cod2, cod4, cod1 e cod3 seja "true" eles imprimiram em conjunto um determinado personagem/elemento na tela, caso não sejam eles imprimiram outro. Caso algum desses"cod" tbm seja false e o resto "true", a estrutura do personagem mudará tbm.
	if (cod2 == true)
	{
		cout << "	       ____	" << endl;
		cout << "	      |||||    " << endl;
